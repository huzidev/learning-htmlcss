...
function go() {
    history.go(2); // WILL LEAD US TO FORWARD OR BACKWARD DEPENDS ON THAT WHICH SIGN WE'VE GIVEN TO IT IF WE GAVE (+VE) SIGN IT'LL GO FORWARD & IF WE GAVE (-VE) SIGN IT'LL GO BACKWARD AND DEPENDING HOW NUMBERS WE ADD
}