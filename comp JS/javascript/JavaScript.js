...
console.log(`The Absolute Value Of 5.666 is ${Math.abs (5.666)} it didn't shows any change because the value is already in +ve way buttt if we put the same value wiht -ve sign it'll show the absolute value `)