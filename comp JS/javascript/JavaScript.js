...
window.alert("hello"); //WE CAN WRITE ALERT FUNCTION LIKE THAT AND BY JUST SIMPLE METHOD BECAUSE WINDOW IS A GLOBAL ELEMENT AND WE DONT HAVE TO PUT IT AGAIN AND AGAIN GLOBAL MEANS IT IS ALL OVER THE PLACE