...
d = innerHeight //INNER HEIGHT THE HEIGHT OF OURS WEBPAGE AND INNER HEIGHT VIEW PORT HEIGHT HOTI HY WHILE (OUTERHEIGHT) BROWSER KI BORDER TO BORDER TAK HOTI H
console.log(d);
